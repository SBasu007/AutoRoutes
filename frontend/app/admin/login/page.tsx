        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-950 p-4 font-sans">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-indigo-500/10 border border-indigo-500/30 rounded-2xl text-indigo-400 mb-4">
                        <ShieldCheck size={32} />
                    </div>
                    <h1 className="text-2xl font-extrabold text-white tracking-tight">Admin Portal</h1>
                    <p className="text-gray-500 text-sm mt-1">MapMyAuto · Restricted Access</p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="block text-sm font-semibold text-gray-400 mb-2">Username or Email</label>
                ...
                <p className="text-center text-gray-700 text-xs mt-6">
                    Not an admin?{" "}
                    <a href="/contributor" className="text-gray-500 hover:text-gray-400 underline transition-colors">
