            ...
            <div className="flex overflow-x-auto gap-3 pb-4 scrollbar-hide snap-x px-1">
                {nearbyRoutes.map((route) => (
                    <button
                        ...
                        className={`flex-shrink-0 text-left w-64 p-4 rounded-2xl transition-all duration-300 snap-center shadow-sm ${
                    ...
                    >
                        ...
                        {route.estimatedTimeMin && (
                            <div className={`flex items-center gap-1.5 mt-2.5 text-[11px] font-semibold w-fit px-2 py-1 rounded-md ${
                                selectedRoute?.id === route.id 
